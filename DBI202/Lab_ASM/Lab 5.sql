...
select dbo.StudentID_Func1('VT01');

--cau 2
create function TotalHoaDon(@MahD nvarchar(10))
returns INT
as
begin
	declare @total int;
...
BEGIN
    UPDATE HOADON
    SET TongTG = (SELECT SUM(SL * GiaBan) FROM CHITIETHOADON WHERE MaHD = HOADON.MaHD)
...
WHERE CT.MaVT = 'VT03'; -- Assuming 'GACH ONG' corresponds to MaVT 'VT03'
